...
SpData <- read.csv("/Users/lisabuche/Code/Project/Caracoles/UnderTheHood/data/competition.csv")
str(SpData)
...
levels(as.factor(SpDataFocal$year))
...
PrelimFit <- stan(file = "Code/Caracoles_BH_FH_Preliminary.stan", data = DataVec,
                  iter = 3000, 
                  chains = 3)
