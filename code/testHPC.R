...
#--- setting ups----    
        ...
        PrelimFit.all <- stan(file = "/Users/lisabuche/Code/Project/HOI_Caracoles/code/Caracoles_BH_FH_Preliminary.stan", 
                              data = DataVec,
                              iter = 100, 
                              chains = 3)
        ...
        pdf(paste0("/Users/lisabuche/Code/Project/HOI_Caracoles/figure/beta_Inclusion_",
