...
theme_white_nogrid  = function(base_size = 12, base_family = "") {
  ...
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
    ...
    theme(
      ...
      axis.title.x = element_text(size = base_size, color = "black", 
                                  margin = margin(0, 10, 0, 0),angle = 60),  
      ...
      legend.title = element_text(size = base_size, face = "bold", hjust = 0, color = "black"),  
      legend.position = "right",  
      legend.text.align = NULL,  
      legend.title.align = NULL,  
      legend.direction = "vertical",  
      ...
      strip.text.y = element_text(size = base_size, color = "black",angle = -90),  
      # Specify plot options
...
theme_black_noline = function(base_size = 12, base_family = "") {
...
theme_black_void = function(base_size = 12, base_family = "") {
